...
namespace NorthwindRestApi.Services.Interfaces
{
    public interface ICustomerService
    {
        ...
        Task<PagedResult<CustomerReadDto>> GetPagedAsync(int page, int pageSize, CancellationToken ct);
        Task<PagedResult<CustomerReadDto>> SearchAsync(CustomerQueryParameters parameters, CancellationToken ct);
