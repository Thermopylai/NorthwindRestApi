...
namespace NorthwindRestApi.Services.Interfaces
{
    public interface IRegionService
    {
        ...
        Task<PagedResult<RegionReadDto>> GetPagedAsync(int page, int pageSize, CancellationToken ct);
        Task<PagedResult<RegionReadDto>> SearchAsync(RegionQueryParameters parameters, CancellationToken ct);
