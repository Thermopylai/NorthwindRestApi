...
namespace NorthwindRestApi.Services.Interfaces
{
    public interface IEmployeeService
    {
        ...
        Task<PagedResult<EmployeeListDto>> GetPagedAsync(int page, int pageSize, CancellationToken ct);
        Task<PagedResult<EmployeeListDto>> SearchAsync(EmployeeQueryParameters parameters, CancellationToken ct);
